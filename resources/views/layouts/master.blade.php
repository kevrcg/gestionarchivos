...
<head>
  ...
  <link rel="stylesheet" href="{{asset('css/lib/admin_lte/skins/skin-blue-light.min.css')}}">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>C</b>RD</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Curaduria</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="upload"><i class="fa fa-link"></i> <span>Subir Archivo</span></a></li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a target="_blank" href="https://www.geostigmamedia.com/web/">Geostigma Media</a>.</strong> All rights reserved.
  </footer>
